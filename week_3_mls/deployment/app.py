...
model_path = hf_hub_download(repo_id="vasanth2081/tourism_prediction_model", filename="best_tourism_prediction_model_v1.joblib")
...
NumberOfChildrenVisiting = st.number_input("Number of Children Visiting",min_value=1, max_value=5, value=3)
